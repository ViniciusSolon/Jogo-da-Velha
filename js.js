...
function disableRegion(element) {
  /// Desabilita uma região do tabuleiro para que não seja mais clicável, element é o evento do span q é pego
...
function handleBoardClick(ev) {
  ...
  //O currentTarget é o span
  const rowColumnPair = region.split(".");
  //separar o numero 0.0
  ...
  //metodo fat achata o array tornando bidimensional em 1
}
